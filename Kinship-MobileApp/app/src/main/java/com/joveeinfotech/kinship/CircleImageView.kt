...
class CircleImageView:ImageView {
   ...
   /* fun CircleImageView(context: Context):Unit {
        super(context)
   ...
   /* fun CircleImageView(context: Context, attrs: AttributeSet):Unit{
   ...
   /* fun CircleImageView(context: Context, attrs: AttributeSet, defStyle: Int):Unit {
