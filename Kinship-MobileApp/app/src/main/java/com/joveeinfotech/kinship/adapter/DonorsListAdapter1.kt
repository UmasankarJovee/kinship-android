...
class DonorsListAdapter1(val getTop20Result: MutableMap<String, MutableList<donationInnerDetails>>, val mcontext: Context): RecyclerView.Adapter<DonorsListAdapter1.ViewHolder>() {
