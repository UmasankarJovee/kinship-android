 ...
 */
class Top20ListAdapter(val getTop20Result:List<GetTop20Result>, val mcontext: Context): RecyclerView.Adapter<Top20ListAdapter.ViewHolder>() {
    ...
    class ViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(getTop20Result : GetTop20Result, colors : Array<String>, position: Int) {
            ...
            itemView.top20_donars_list_Linear_layout_CardView_TextView_total_like.text = getTop20Result.total_like.toString()
