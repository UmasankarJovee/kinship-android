...
class SettingsFragmentPresenterImpl:SettingsFragmentPresenter {
    ...
    constructor(view:SettingsFragmentView, context: Context,listeners: Listener){
    ...
    override fun initPresenter() {
        ...
        val adapter= CustomeAdapter(items,listener)
    ...
    override fun getLanguagesData() {
        ...
        Log.e("Message","Before call CustomeAdapter class" )
        val adapter= LanguageListAdapter(items,listener)
