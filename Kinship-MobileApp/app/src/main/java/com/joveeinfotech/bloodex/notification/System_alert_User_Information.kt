 ...
 */
class System_alert_User_Information : Service() {
    ...
    override fun onCreate() {
        ...
        val myView = inflater.inflate(R.layout.system_alert_user_information_get, null)
        ...
        myView.system_alert_user_information_get_info_textView.text = "      ${info}"

        myView.system_alert_user_information_get_ok_button.setOnTouchListener(object : View.OnTouchListener {
