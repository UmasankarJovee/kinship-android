...
class UserProfileEdit : AppCompatActivity(), UserProfileEditFragmentView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
             ...
             val city: EditText =dialogView.findViewById(R.id.alert_address_details_scrollView_linearLayout1_city_editText)*/
                ...
                dialogView?.alert_address_details_scrollView_linearLayout1_linearLayout2_linearLayout3_okButton?.setOnClickListener {
                   /* //userProfileEditFragmentPresenterImpl?.sendAddress()
                    ...
                    if(dialogView?.alert_address_details_scrollView_linearLayout1_country_spinner!!.text.isNotEmpty()
                            && dialogView?.alert_address_details_scrollView_linearLayout1_state_spinner!!.text.isNotEmpty()
                            && dialogView?.alert_address_details_scrollView_linearLayout1_district_spinner!!.text.isNotEmpty()
                            && dialogView?.alert_address_details_scrollView_linearLayout1_city_editText!!.text.isNotEmpty()
                            && dialogView?.alert_address_details_scrollView_linearLayout1_locality_editText!!.text.isNotEmpty()
                            && dialogView?.alert_address_details_scrollView_linearLayout1_street_editText!!.text.isNotEmpty()){

                        userProfileEditFragmentPresenterImpl?.userAddressDetails(dialogView?.alert_address_details_scrollView_linearLayout1_country_spinner!!.text.toString(),
                                dialogView?.alert_address_details_scrollView_linearLayout1_state_spinner!!.text.toString(),
                                dialogView?.alert_address_details_scrollView_linearLayout1_district_spinner!!.text.toString(),
                                dialogView?.alert_address_details_scrollView_linearLayout1_city_editText!!.text.toString(),
                                dialogView?.alert_address_details_scrollView_linearLayout1_locality_editText!!.text.toString(),
                                dialogView?.alert_address_details_scrollView_linearLayout1_street_editText!!.text.toString())
                    }
        ...
        override fun setCountries(countryList: ArrayList<String>) {
            ...
            val dataAdapter = ArrayAdapter(this@UserProfileEdit, android.R.layout.simple_spinner_item, country_array)
            dialogView?.alert_address_details_scrollView_linearLayout1_country_spinner?.threshold=1
            dialogView?.alert_address_details_scrollView_linearLayout1_country_spinner?.setAdapter<ArrayAdapter<String>>(dataAdapter)

            userProfileEditFragmentPresenterImpl?.sendCountryReceiveState()
        ...
        override fun setStates(stateList: ArrayList<String>) {
            ...
            val dataAdapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, state_array)
            dialogView?.alert_address_details_scrollView_linearLayout1_state_spinner?.threshold=1
            dialogView?.alert_address_details_scrollView_linearLayout1_state_spinner?.setAdapter<ArrayAdapter<String>>(dataAdapter)
            userProfileEditFragmentPresenterImpl?.sendStateReceiveDistrict()
            /*dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        ...
        override fun setDistricts(districtList:ArrayList<String>) {
            ...
            val dataAdapter = ArrayAdapter(this, android.R.layout.simple_spinner_item,district_array)
            dialogView?.alert_address_details_scrollView_linearLayout1_district_spinner?.threshold=1
            dialogView?.alert_address_details_scrollView_linearLayout1_district_spinner?.setAdapter<ArrayAdapter<String>>(dataAdapter)
            /*dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
